...
== Setup
  ...
  <script src="http://alpha.uncoverage.com/assets/widget/widget_integration_code.js"></script>
  <iframe id="integration_widget" src="http://alpha.uncoverage.com/integration_widget?journalist_id=<JOURNALIST ID>" style="display: none;"/></iframe>
...
1.Create: 
  POST http://alpha.uncoverage.com/api/journalists/<Journalist Id>/subscriptions

2.Update:
  PUT http://alpha.uncoverage.com/api/journalists/<Journalist Id>/subscriptions/<Subscription Id>

== etc 

It uses token authentication, I'll send you the API key to use.
